...
struct Input_para
{
    ...
    int gga_grad = 0;                       ///< GGA gradient method for noncollinear spin (nspin=4): 0=original algorithm (default), 1=collinear approx, 2=projected div(h), 3=Scalmani-Frisch transform
    int pw_diag_nmax = 50;
