    ...
    double &v2c)
{
    ...
    double p3 = 8.7230;
    double p4 = 0.4720;
    double pc1 = 0.0016670;
    double pc2 = 0.0025680;
    double pci = pc1 + pc2;
    double third = 1.0 / 3.0;
    double pi34 = 0.62035049089940;  // pi34=(3/4pi)^(1/3)
